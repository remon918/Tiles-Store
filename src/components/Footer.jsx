...
import { FaFacebookF, FaInstagram, FaYoutube, FaLinkedinIn, FaPinterestP, FaPhone, FaPhoneAlt } from "react-icons/fa";
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
        ...
        <div>
          ...
          <div className="flex gap-3 mb-4">
            {[FaFacebookF, FaInstagram, FaYoutube, FaLinkedinIn, FaPinterestP].map((Icon, i) => (
              <div key={i} className="border p-2 rounded-full hover:bg-white hover:text-black cursor-pointer">
                <Icon size={14} />
              </div>
            ))}
          </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            {["About Us", "Why Choose Us", "News And Events", "FAQ", "Our Projects"].map((item, i) => (
              <li key={i} className="hover:text-white cursor-pointer">{item}</li>
            ))}
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            {["Contact Us", "Store Locator", "Tiles Calculator"].map((item, i) => (
              <li key={i} className="hover:text-white cursor-pointer">{item}</li>
            ))}
          </ul>
        </div>
